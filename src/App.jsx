  ...
  return (
    <div className="container">
      ...
      <div className="current-scrum-master-card">
        ...
        {currentScrumMaster ? (
          <div className="current-scrum-master-name">
            {currentScrumMaster.name}
          </div>
        ) : (
          <div className="no-members-message">
            Please add team members to generate rotation
          </div>
        )}
          ...
          <div>
            <div className="input-container">
              <input
                ...
                className="input"
                onKeyDown={addTeamMemberEnterKey}
              />
